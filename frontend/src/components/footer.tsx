...
export function Footer() {
  ...
  return (
    <footer className="mt-auto" style={{ background: "linear-gradient(180deg, #0F172A 0%, #0C1322 100%)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-[#94A3B8] text-sm max-w-md mb-6 leading-relaxed">
              Helping Indian students find their perfect university abroad. 
              Personalized guidance from expert counselors who understand your journey.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-[#94A3B8] text-sm pl-10">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-[#64748B] text-sm">
            © {currentYear} WingsEd. All rights reserved.
          </p>
